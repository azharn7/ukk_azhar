...
<head>
  ...
  <title>Aplikasi Pengaduan Masyarakat | Azhar</title>
...
if (isset($_GET['page'])) {
 ...
 ?>
<footer class="fixed-bottom" style="background-color: lightblue">
  <div class="container">
    <p class="text-center">UKK RPL 2023 | Azhar | SMK MAHARDIKA</p>
  </div>
